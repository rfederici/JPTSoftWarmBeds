...
{
    public class Graphic_MultiB : Verse.Graphic_Multi
    {
        public override void Init(GraphicRequest req)
        {
            ...
            for (int i = 0; i < this.mats.Length; i++)
            {
                ...
                req2.colorThree = this.colorThree;
                req2.maskTex = array2[i];
                req2.shaderParameters = req.shaderParameters;
                this.mats[i] = MaterialPool.MatFrom(req2);
            }
        }
        public override Graphic GetColoredVersion(Shader newShader, Color newColor, Color newColorThree)
        {
            return GraphicDatabase.Get<Graphic_Multi>(this.path, newShader, this.drawSize, newColor, newColorThree, this.data);
        }
        ...
        public override int GetHashCode()
        {
            ...
            return Gen.HashCombineStruct<Color>(seed, this.colorThree);
        }
